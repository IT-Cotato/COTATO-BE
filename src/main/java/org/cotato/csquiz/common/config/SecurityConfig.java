    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .authorizeHttpRequests(request -> request
                                ...
                                .requestMatchers("/v2/api/attendances/records").hasAnyRole("ADMIN", "OPERATION")
                                .requestMatchers("/v2/api/attendances/{attendance-id}/records").hasAnyRole("ADMIN", "OPERATION")
                                .requestMatchers("/v2/api/attendances").hasAnyRole("ADMIN", "OPERATION")
                                .requestMatchers("/v2/api/attendances/info").hasAnyRole("ADMIN","OPERATION","EDUCATION","MEMBER")
                                .requestMatchers("/v2/api/attendances/records/**").hasAnyRole("ADMIN","OPERATION","EDUCATION","MEMBER")
