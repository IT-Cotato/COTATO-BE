...
public interface MemberRepositoryCustom {
    ...
    Page<Member> findAllWithFiltersPageable(Integer passedGenerationNumber, MemberPosition memberPosition, MemberStatus memberStatus, String name, Pageable pageable);
}
