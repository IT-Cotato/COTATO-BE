...
public class PolicyService {
	...
	public FindMemberPolicyResponse findUnCheckedPolicies(final Member member, final PolicyCategory category) {
		...
		return FindMemberPolicyResponse.of(member, policiesByType.getOrDefault(PolicyType.ESSENTIAL, List.of()),
			policiesByType.getOrDefault(PolicyType.OPTIONAL, List.of()));
	}
