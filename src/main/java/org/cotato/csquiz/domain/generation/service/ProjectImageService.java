...
import org.cotato.csquiz.common.util.FileUtil;
...
public class ProjectImageService {
    ...
    public void createProjectImage(Long projectId, MultipartFile logoImage, MultipartFile thumbNailImage)
        ...
        File webpLogoImage = FileUtil.convertToWebp(s3Uploader.convert(logoImage));
        ...
        File webpThumbNailImage = FileUtil.convertToWebp(s3Uploader.convert(thumbNailImage));
